/*
 * $Id: evdev.c,v 1.4 2005-06-16 17:04:08 pingc Exp $
 *
...
{
	printk(KERN_INFO "evdev.c: version " EVDEV_VERSION "\n");
...
#ifndef __JEJ_DEBUG
MODULE_DESCRIPTION("Event character device driver (LINUXWACOM)");
#else
MODULE_DESCRIPTION("Event character device driver (LINUXWACOM-DEBUG)");
#endif
MODULE_LICENSE("GPL");
